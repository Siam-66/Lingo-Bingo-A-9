...
const Banner = () => {
    ...
    return (
        <div>
        <div className="relative lg:h-[800px] md:h-[600px] overflow-hidden max-sm:h-[400px] mb-5 ">
            <video 
                ref={videoRef}
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center mt-14 z-20 top-[50px]  lg:top-[250px] md:top-[20px] ">
                ...
                <Link to="/startLearning" className='mt-2 text-white hover:scale-105 duration-[0.3s] lg:text-4xl md:text-2xl border-2 p-3 rounded-2xl'>Start Learning</Link>
            </div>
            <button 
